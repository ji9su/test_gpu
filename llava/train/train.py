...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in sources[0]:
            ...
            image_file = "data/images/29168752_molecules-22-02046-f002.jpg"
...
def train():
    ...
    # model_args.model_name_or_path: ./checkpoints/LLaVA-7b-v0
    ...
    if model_args.version == "v0":      # model_args.version: v0
    ...
    if model_args.vision_tower is not None:
        ...
        # image_forward_outs = model.model.vision_tower[0](images, output_hidden_states=True)
        # select_hidden_state = image_forward_outs.hidden_states[-1]
        ...
        params_no_grad = [n for n, p in model.named_parameters() if p.requires_grad]
